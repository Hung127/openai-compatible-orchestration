...
from adapters.controllers.external_to_internal_openai import \
    OpenAI2InternalInConverter
...
from adapters.presenters.internal_to_external_openai import \
    Internal2OpenAIConverter
from infrastructure.interfaces.i_provider import IProvider
from infrastructure.providers.llm7 import LLM7Provider
...
def get_provider(
    ...
    return OllamaProvider(
        base_url="https://ollama.com/v1",  # Ollama with openai-compatible api
